      ...
      <header className='bg-black text-white'>
        ...
        {isOpen && (
          <div className='md:hidden flex flex-col px-6 pb-4 gap-3 bg-black border-t border-white/10'>
            ...
            <Link to="#" className='font-medium text-[16px] py-2 border-b border-gray-700 hover:text-[#FFC100]'>ABOUT</Link>
            <Link to="#" className='font-medium text-[16px] py-2 border-b border-gray-700 hover:text-[#FFC100]'>CONNECT US</Link>
