  ...
  >
    ...
    <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-10 text-white relative z-10">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
        <h1 className="text-2xl lg:text-4xl font-bold font-roboto mb-6">
        ...
        <h2 className="text-lg lg:text-2xl font-semibold mb-4 px-2">
          What does Kerala's Biggest Freelancer Community mean?
        </h2>

        <p className="text-sm lg:text-base px-2 lg:px-0 leading-relaxed text-gray-200 max-w-[500px]">
        ...
        <div className="flex items-center justify-center space-x-2 mt-6 lg:mt-10">
